      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-6 md:gap-8 flex-1">
        ...
        <section className="xl:col-span-8 bg-surface-container-lowest rounded-[2rem] p-4 lg:p-6 shadow-sm border border-outline-variant/15 flex flex-col relative overflow-hidden min-h-[400px] md:min-h-[500px]">
          ...
          <div className="flex-1 rounded-2xl bg-surface-container-high relative overflow-hidden flex items-center justify-center min-h-[400px]">
            ...
            <div id="remark-scanner-region" className={`absolute inset-0 w-full h-full ${isCameraOpen ? 'block' : 'hidden'}`}></div>
        ...
        {/* Student Profile & Remarks Form Panel */}
          ...
          {scannedStudent ? (
            <div className="flex flex-col h-full justify-between">
              <div>
                ...
                <div className="bg-surface-bright rounded-2xl p-4 border border-outline-variant/10 space-y-3 mb-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="relative">
                    <select
                      className="w-full bg-surface border border-outline-variant/50 rounded-xl py-3 px-4 text-on-surface focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary appearance-none font-body text-sm shadow-sm"
                  ...
                  {selectedRemark === 'Others' && (
                    <div className="mt-3 animate-fade-in">
                      <label className="block font-label text-xs uppercase tracking-widest text-on-surface-variant font-bold mb-1.5">
                        Custom Remark
                      </label>
                      <textarea
                        className="w-full bg-surface border border-outline-variant/50 rounded-xl p-3 text-on-surface focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary font-body text-xs resize-none"
                        rows={3}
                        placeholder="Explain custom remark detail here..."
                        value={customRemark}
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-surface-container-lowest max-w-sm w-full rounded-[2rem] p-6 shadow-2xl border border-outline-variant/10 text-center animate-scale-up">
            ...
            <h3 className="font-display font-bold text-xl text-on-surface mb-2">Remark Logged</h3>
